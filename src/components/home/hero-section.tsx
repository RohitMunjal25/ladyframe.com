...
const heroClasses = {
  ...
  'spotlight-split': {
    section: 'border-b border-[rgba(176,228,204,0.2)] bg-[linear-gradient(180deg,#091413_0%,#0f2a24_52%,#ecfdf5_100%)] text-white',
    overlay: 'bg-[linear-gradient(90deg,rgba(9,20,19,0.92)_0%,rgba(15,45,38,0.55)_48%,rgba(236,253,249,0)_100%)]',
    grid: 'lg:grid-cols-[1.14fr_0.86fr]',
    card: 'border border-[rgba(176,228,204,0.16)] bg-[rgba(9,20,19,0.35)] shadow-[0_28px_100px_rgba(0,0,0,0.38)] backdrop-blur-md',
    title: 'text-white',
    body: 'text-[#b0e4cc]/85',
    badge: 'bg-[#b0e4cc] text-[#091413]',
    primary: 'bg-[#b0e4cc] text-[#091413] hover:bg-[#9fd6b8]',
    secondary: 'border border-[rgba(176,228,204,0.35)] bg-white/10 text-white hover:bg-white/16',
  },
  'gallery-mosaic': {
