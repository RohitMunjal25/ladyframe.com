...
const recentActivity = [
  {
    ...
    target: "Designing shelves people actually scan",
    time: "5 min ago",
  ...
  },
  {
    ...
    type: "like",
    user: "Chris Okonkwo",
    action: "saved your bookmark list",
    target: "Performance reading list",
    time: "15 min ago",
    avatar: "/placeholder.svg?height=40&width=40",
  },
  {
  ...
  },
  {
    ...
    type: "message",
    user: "Jordan Ellis",
    action: "messaged you about",
    target: "your public LadyFrame profile",
    time: "2 hours ago",
    avatar: "/placeholder.svg?height=40&width=40",
  },
]
